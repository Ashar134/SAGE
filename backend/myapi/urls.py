...
urlpatterns = [
    ...
    path("api/interview/tts/", views.interview_tts, name="interview_tts"),
    path("api/interview/stt/", views.interview_stt, name="interview_stt"),
    path("api/interview/submit/", views.interview_submit, name="interview_submit"),
    path("api/interview/upload-video/", views.interview_upload_video, name="interview_upload_video"),
]
